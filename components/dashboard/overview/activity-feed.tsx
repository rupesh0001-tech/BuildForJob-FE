...
export function ActivityFeed() {
  return (
    <div className="lg:col-span-2 rounded-2xl border border-gray-300 dark:border-white/10 bg-white dark:bg-white/5 p-6 shadow-sm flex flex-col justify-center min-h-[250px] relative overflow-hidden">
        ...
        <div className="text-center z-10 flex flex-col items-center">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 max-w-sm mx-auto">Start building a resume or generating a cover letter to see your statistics dashboard populate here.</p>
        </div>
    </div>
  );
}
