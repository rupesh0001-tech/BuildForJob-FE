                ...
                >
                  <div className="flex items-center gap-3">
                    <item.icon
                      ...
                      className={cn(
                        "transition-colors",
                        isActive ? "text-purple-600 dark:text-purple-400" : isSoon ? "text-gray-300 dark:text-gray-700" : "text-gray-700 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-gray-300"
                      )}
                    />
                    {item.name}
                  </div>
                  {isSoon && (
                    <span className="text-[10px] font-bold px-1.5 py-0.5 bg-gray-100 dark:bg-white/5 text-gray-500 dark:text-gray-400 rounded-md uppercase tracking-tighter">
                      Soon
                    </span>
                  )}
                </Link>
